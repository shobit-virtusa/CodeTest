 ...
 */
public class HundredThousands extends NumberToEnglishWordsHelper implements CurrencyConverter {

	/**
     * for logging.
     */
	private static Logger log = LoggerFactory.getLogger(HundredThousands.class);
	
    /**
     * This method is used to calculate hundred thousands in the input number.
     * 
     * @param number
     *            input number
     * @return String tradHundredThousands.
     */
    @Override
    public String calculateCurrency(String number) throws CurrencyException {

        log.info("Start: HundredThousands.calculateCurrency method ");
        // nnnnnnXXXnnn
        int hundredThousands = getNumber(number, CurrencyConstants.numSix, CurrencyConstants.numNine);

        String tradHundredThousands;
        switch (hundredThousands) {
        case 0:
            tradHundredThousands = CurrencyConstants.emptyString;
            break;
        case 1:
            tradHundredThousands = CurrencyConstants.oneThousand;
            break;
        default:
            tradHundredThousands = convertNumberLessThanThousand(hundredThousands) + CurrencyConstants.thousand;
        }
        log.info("End: HundredThousands.calculateCurrency method ");
